...
export const CONTRACT_ADDRESSES = {
  VAULT: process.env.NEXT_PUBLIC_VAULT_CONTRACT || 'CDDJFHJC4IDIU2ML2JAN6TW7PRBGCCRODKKHMOJ4MRY7JOCODBQ5GTO3',
  ORACLE: process.env.NEXT_PUBLIC_ORACLE_CONTRACT || 'CDMB74GU3Q7B4GHBVBI34W7BWXVTXCKT5WU5ISPBHIFQ5RPVBTZRZYDC',
