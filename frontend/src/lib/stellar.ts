...
export const CONTRACT_ADDRESSES = {
  VAULT: process.env.NEXT_PUBLIC_VAULT_CONTRACT || 'CAAAN6MOXVPUDWNDPBMNVMQP4RIA7PS4RJDC3IMGQZ6FRBFIWSE6ZQHB',
  ORACLE: process.env.NEXT_PUBLIC_ORACLE_CONTRACT || 'CBDJT4YBL5C7GSHB7TEKKS3C6WAX5SWT4652H4R7A4MYL75S6LQ7YRPS',
